...
public class Scoreboard {
	public void writeScore(String name, int score) throws IOException {
		try {
			FileWriter myWriter = new FileWriter("src/Resources/scores.txt", true);
			BufferedWriter bw = new BufferedWriter(myWriter);
			BufferedReader fileRead = new BufferedReader(new FileReader("src/Resources/scores.txt"));
	...
	public LinkedHashMap<String, Integer> readScore() throws IOException {
		BufferedReader fileReader = new BufferedReader(new FileReader("src/Resources/scores.txt"));
